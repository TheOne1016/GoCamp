...
// SaveEditInfo mocks base method.
func (m *MockUserRepository) SaveEditInfo(ctx context.Context, u domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveEditInfo", ctx, u)
	ret0, _ := ret[0].(error)
	return ret0
}

// SaveEditInfo indicates an expected call of SaveEditInfo.
func (mr *MockUserRepositoryMockRecorder) SaveEditInfo(ctx, u any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveEditInfo", reflect.TypeOf((*MockUserRepository)(nil).SaveEditInfo), ctx, u)
}
