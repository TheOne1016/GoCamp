...
// OAuth2WechatHandler 用来处理和微信 OAuth2 有关的事情
...
func NewOAuth2WechatHandler(svc wechat.Service,
	...
	return &OAuth2WechatHandler{
		svc:      svc,
		userSvc:  userSvc,
		stateKey: []byte("Pe9um9NrZbtVbGzmjIaoMXa4WbY01iuy"),
		cfg:      cfg,
		Handler:  jwtHdl,
	}
}
...
func (h *OAuth2WechatHandler) AuthURL(ctx *gin.Context) {
	...
	if er := h.setStateCookie(ctx, state); er != nil {
		ctx.JSON(http.StatusOK, Result{
			Code: 5,
			Msg:  "系统异常",
		})
...
func (h *OAuth2WechatHandler) verifyState(ctx *gin.Context) error {
	...
	var sc StateClaims
	token, err := jwt.ParseWithClaims(ck, &sc, func(t *jwt.Token) (interface{}, error) {
